...
Namely, there exists a harmonic map $f$ from a closed disc to a disc with a metric which is flat except for one cone point $q$ of negative curvature such that $f^{-1}\{q\}$ is a nontrivilal tree.
...
\bibitem{petrunin-stadler} Petrunin, A., Stadler, S. \textit{Metric minimzing surfaces revisited}
in preparation.
