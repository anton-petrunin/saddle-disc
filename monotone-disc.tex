...
Stephan Stadler,
\par\nopagebreak\textsc{Mathematisches Institut der Universität M\"unchen, Theresienstr. 39, D-80333 M\"unchen, Germany}
\par\nopagebreak
...
Assume $\Delta=(\DD,|{*}-{*}|)$ is a disc with Riemannian metric such that any two points $x,y\in\Delta$ are joined by a geodesic $[x,y]$.
...
the harmonic maps into such spaces can be also defined as local energy minimizers, see \cite{GS} and \cite{KS}.
